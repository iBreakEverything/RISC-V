...
always@(*) begin
    casex({ALUop,funct7,funct3})
        ...
        12'b110000000000: ALUinput <= {4'b0010};  //add
        12'b110100000000: ALUinput <= {4'b0110};  //sub
        12'b110000000111: ALUinput <= {4'b0000};  //and
        12'b110000000110: ALUinput <= {4'b0001};  //or
        12'b110000000100: ALUinput <= {4'b0011};  //xor
